<p align="center">
    <img src="https://github.com/user-attachments/assets/188c42f8-d249-4a72-b27a-e2b4f10a00a8" alt="Zii Chat Android Logo" width="480">
</p>

> [!WARNING]
> This software has not received external security review and may contain vulnerabilities and may not necessarily meet its stated security goals. Do not use it for sensitive use cases, and do not rely on its security until it has been reviewed. Work in progress.

# Zii Chat for Android

A secure, decentralized, peer-to-peer messaging app that works over Bluetooth mesh networks. No internet required for mesh chats, no servers, no phone numbers - just pure encrypted communication. Zii Chat also supports geohash channels, which use an internet connection to connect you with others in your geographic area.

This is the **Android version** of Zii Chat, built on proven mesh networking technology for reliable cross-platform communication.

## Install Zii Chat

You can download the latest version of Zii Chat for Android from the releases section.
...
- **✅ Cross-Platform Compatible**: Advanced mesh networking protocol
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/yourusername/zii-chat-android.git
   cd zii-chat-android
   ```
...
2. **Open in Android Studio:**
   ...
   # Navigate to the zii-chat-android directory
   ```
...
3. **Launch Zii Chat** - it will auto-start mesh networking
4. **Set your nickname** or use the auto-generated one
5. **Connect automatically** to nearby Zii Chat users
...
### Binary Protocol
Zii Chat uses an efficient binary protocol optimized for Bluetooth LE:
...
1. **ZiiApplication.kt**: Application-level initialization and dependency injection
...
Zii Chat enables seamless cross-platform communication:

- **Android ↔ Desktop**: Full bidirectional messaging
- **Mixed Networks**: Multiple device types in same mesh
- **Feature Parity**: All commands and encryption work across platforms
- **Protocol Sync**: Consistent message format and routing behavior

**Desktop Version**: Zii Chat desktop app provides web and Electron interfaces
...
- **Cross-Platform**: Ensure compatibility with Zii Chat desktop

For desktop-specific issues, please refer to the Zii Chat desktop repository.
