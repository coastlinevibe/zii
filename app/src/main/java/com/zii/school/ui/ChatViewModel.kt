...
class ChatViewModel(
    ...
    private fun deleteMessage(messageId: String) {
        Log.d(TAG, "🗑️ Auto-deleting message: ${messageId.take(8)}...")
    ...
    private fun dismissNotificationForMessage(messageId: String) {
        Log.d(TAG, "🔕 Dismissing notification for message: ${messageId.take(8)}...")
    ...
    private fun deleteLocationNote(noteId: String) {
        Log.d(TAG, "🗑️ Auto-deleting location note: ${noteId.take(8)}...")
        try {
