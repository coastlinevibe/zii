...
import com.zii.school.ui.media.FullScreenImageViewer
...
fun ChatScreen(
    ...
    // Simple hints system
    val hintManager = com.zii.school.onboarding.rememberSimpleHintManager()
    ...
    val displayMessages = when {
        ...
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.zii.school.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.zii.school.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.zii.school.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.zii.school.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
    ...
    ChatInputSection(
        ...
        ChatFloatingHeader(
            ...
            onPanicClear = { 
                ...
                val onboardingPrefs = com.zii.school.onboarding.OnboardingPrefs.getInstance(context)
                onboardingPrefs.resetOnboarding()
            },
            onLocationChannelsClick = { /* Geohash removed - BT mesh only */ },
            onLocationNotesClick = { /* Location notes removed - BT mesh only */ }
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.zii.school.R.string.cd_scroll_to_bottom),
...
private fun ChatDialogs(
    ...
    if (showDebugSheet) {
        com.zii.school.ui.debug.DebugSettingsSheet(
    ...
    // Location sheets removed - BT mesh only
