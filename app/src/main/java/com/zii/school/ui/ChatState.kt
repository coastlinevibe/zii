...
class ChatState {
    ...
    private val _selectedLocationChannel = MutableLiveData<com.zii.school.geohash.ChannelID?>(com.zii.school.geohash.ChannelID.Mesh)
    val selectedLocationChannel: LiveData<com.zii.school.geohash.ChannelID?> = _selectedLocationChannel
    ...
    fun setSelectedLocationChannel(channel: com.zii.school.geohash.ChannelID?) {
