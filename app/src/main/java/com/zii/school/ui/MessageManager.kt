...
import com.zii.school.model.DeliveryStatus
import java.util.*
...
class MessageManager(private val state: ChatState) {
    ...
    private val MESSAGE_DEDUP_TIMEOUT = com.zii.school.util.AppConstants.UI.MESSAGE_DEDUP_TIMEOUT_MS // 30 seconds
    private val SYSTEM_EVENT_DEDUP_TIMEOUT = com.zii.school.util.AppConstants.UI.SYSTEM_EVENT_DEDUP_TIMEOUT_MS // 5 seconds
    
    // Auto-delete manager reference (set by ChatViewModel)
    var autoDeleteManager: com.zii.school.messages.MessageAutoDeleteManager? = null
    ...
    fun addMessage(message: BitchatMessage) {
        ...
        autoDeleteManager?.scheduleMessageDeletion(message)
    }
    ...
    fun addSystemMessage(text: String) {
        ...
        // Schedule auto-delete for system messages too
        autoDeleteManager?.scheduleSystemMessageDeletion(sys.id)
    }
