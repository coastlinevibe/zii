package com.zii.school.mesh

import android.content.Context
import android.util.Log
import com.zii.school.crypto.EncryptionService
import com.zii.school.model.BitchatMessage
import com.zii.school.protocol.MessagePadding
import com.zii.school.model.RoutedPacket
import com.zii.school.model.IdentityAnnouncement
import com.zii.school.protocol.BitchatPacket
import com.zii.school.protocol.MessageType
import com.zii.school.protocol.SpecialRecipients
import com.zii.school.model.RequestSyncPacket
import com.zii.school.sync.GossipSyncManager
import com.zii.school.util.toHexString
...
class BluetoothMeshService(private val context: Context) {
    ...
    companion object {
        ...
        private val MAX_TTL: UByte = com.zii.school.util.AppConstants.MESSAGE_TTL_HOPS
    }
    ...
    // WiFi handshake removed - BT mesh only
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.zii.school.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.zii.school.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.zii.school.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
    ...
    private fun setupDelegates() {
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun updatePeerIDBinding(newPeerID: String, nickname: String,
                ...
                // Nostr mapping removed - BT mesh only
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            ...
            override fun handleWiFiHandshakeRequest(routed: RoutedPacket) {
                // WiFi Direct removed - BT mesh only
            }
            
            override fun handleWiFiHandshakeResponse(routed: RoutedPacket) {
                // WiFi Direct removed - BT mesh only
            }
        ...
        connectionManager.delegate = object : BluetoothConnectionManagerDelegate {
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.zii.school.ui.debug.DebugSettingsManager.getInstance()
     ...
     */
    fun sendFileBroadcast(file: com.zii.school.model.BitchatFilePacket) {
        try {
     ...
     */
    fun sendFilePrivate(recipientPeerID: String, file: com.zii.school.model.BitchatFilePacket) {
        try {
            ...
            serviceScope.launch {
                ...
                if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                    try {
                        ...
                        val noisePayload = com.zii.school.model.NoisePayload(
                            type = com.zii.school.model.NoisePayloadType.FILE_TRANSFER,
                            data = filePayload
                        )
                        ...
                        val packet = BitchatPacket(
                            ...
                            payload = encrypted,
                            signature = null,
                            ttl = com.zii.school.util.AppConstants.MESSAGE_TTL_HOPS
                        )
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.zii.school.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.zii.school.model.NoisePayload(
                        type = com.zii.school.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            // Geohash alias removed - BT mesh only
            
            try {
                // Create read receipt payload using NoisePayloadType exactly like iOS
                val readReceiptPayload = com.zii.school.model.NoisePayload(
                    type = com.zii.school.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = BitchatPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.zii.school.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
    ...
    fun sendBroadcastAnnounce() {
        ...
        serviceScope.launch {
            ...
            // Friend code removed - BT mesh only
            val friendCode: String? = null
            
            // Create iOS-compatible IdentityAnnouncement with TLV encoding (includes friend code)
            val announcement = IdentityAnnouncement(nickname, staticKey, signingKey, friendCode)
            ...
            connectionManager.broadcastPacket(RoutedPacket(signedPacket))
            Log.d(TAG, "Sent iOS-compatible signed TLV announce (${tlvPayload.size} bytes, friendCode=${friendCode != null})")
     ...
     */
    fun getSessionState(peerID: String): com.zii.school.noise.NoiseSession.NoiseSessionState {
