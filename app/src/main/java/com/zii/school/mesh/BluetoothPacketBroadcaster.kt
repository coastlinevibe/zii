...
class BluetoothPacketBroadcaster(
    ...
    companion object {
        ...
        private const val CLEANUP_DELAY = com.zii.school.util.AppConstants.Mesh.BROADCAST_CLEANUP_DELAY_MS
    }
    ...
    private fun logPacketRelay(
        ...
        try {
            ...
            com.zii.school.ui.debug.DebugSettingsManager.getInstance().logPacketRelayDetailed(
                packetType = typeName,
