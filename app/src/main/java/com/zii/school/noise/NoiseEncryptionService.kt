package com.zii.school.noise

import android.content.Context
import android.util.Log
import com.zii.school.identity.SecureIdentityStateManager
import com.zii.school.mesh.PeerFingerprintManager
import com.zii.school.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.zii.school.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.zii.school.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.zii.school.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.zii.school.protocol.BitchatPacket): com.zii.school.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.zii.school.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
