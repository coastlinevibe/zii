package com.zii.school.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.zii.school.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.zii.school.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.zii.school.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.zii.school.model.BitchatMessageType.Audio
            else -> com.zii.school.model.BitchatMessageType.File
        }
    }
}
